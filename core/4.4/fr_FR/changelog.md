...
Le changelog de Jeedom Core 4.5 est disponible [ici](https://doc.jeedom.com/core/4.5/fr_FR/changelog)
...
- Ajout d'exemple de code sur la documentation de [personnalisation de jeedom](https://doc.jeedom.com/core/4.4/fr_FR/custom) (à consulter pour ceux voulant pousser la personnalisation)
...
- **Core** : Début du développement en pure js, sans jQuery. Voir [doc dev](https://doc.jeedom.com/dev/fr_FR/core4.4).
- **Core** : Listing plus détaillé des périphériques USB.
- **Core** : Un menu contextuel a été ajouté à différents endroits au niveau des cases à cocher pour les sélectionner toutes, aucunes, ou inverser la sélection *(voir [Doc dev](https://doc.jeedom.com/dev/fr_FR/core4.4))*.
...
> Les tuiles s'adaptent aux dimensions de la grille et peuvent faire une fois, deux fois etc. ces valeurs en hauteur ou largeur. Il faudra certainement passer en [mode Edition du Dashboard](https://doc.jeedom.com/core/4.4/fr_FR/dashboard#Mode%20%C3%A9dition) pour affiner la taille de certaines tuiles après la mise à jour.
...
- Ajout de la description **source** pour les actions messages (voir [Doc dev](https://doc.jeedom.com/dev/fr_FR/core4.3)).
...
cf [Doc dev](https://doc.jeedom.com/dev/fr_FR/core4.3).
...
- **Résumés** : Il est maintenant possible de configurer des [actions sur les résumés](/concept/fr_FR/summary#Actions sur résumés) (ctrl + clic sur un résumé) grâce aux virtuels.
...
Les plugins doivent respecter les recommandations sur l'arborescence des dossiers et fichiers : [Doc](https://doc.jeedom.com/dev/fr_FR/plugin_template).
