...
- Se agregó código de muestra a la documentación [personalización jeedom](https://doc.jeedom.com/core/4.4/es_ES/custom) (consultar para aquellos que quieran impulsar la personalización)
...
- **Centro** : Inicio de desarrollo en js puro, sin jQuery. Ver [Desarrollador de documentos](https://doc.jeedom.com/dev/es_ES/core4.4).
- **Centro** : Lista más detallada de dispositivos USB.
- **Centro** : Se ha añadido un menú contextual en diferentes lugares al nivel de los checkboxes para seleccionarlos todos, ninguno, o invertir la selección *(ver [Desarrollador de documentos](https://doc.jeedom.com/dev/es_ES/core4.4))*.
...
> Los mosaicos se adaptan a las dimensiones de la cuadrícula y se pueden hacer una, dos veces, etc. estos valores en alto o ancho. Sin duda será necesario pasar [Modo de edición del tablero](https://doc.jeedom.com/core/4.4/es_ES/dashboard#Mode%20%C3%A9dition) para ajustar el tamaño de algunos mosaicos después de la actualización.
...
- Descripción añadida **fuente** para acciones de mensajes (ver [Desarrollador de documentos](https://doc.jeedom.com/dev/es_ES/core4.3)).
...
ver [Desarrollador de documentos](https://doc.jeedom.com/dev/es_ES/core4.3).
...
- **Widgets** : Internacionalización de Widgets de terceros (código de usuario).
...
- **Resúmenes** : Ahora es posible configurar [acciones sobre resúmenes](/concept/es_ES/summary#Actions seguro résumés) (ctrl + clic en un resumen) gracias a los virtuales.
- **Relación** : Vista previa de archivos PDF.
- **Tipos de equipo** : Nueva página **Herramientas → Tipos de equipos** permitiendo la asignación de tipos genéricos a dispositivos y comandos, con soporte para tipos dedicados a complementos instalados.
...
Los complementos deben respetar las recomendaciones sobre la estructura de árbol de carpetas y archivos : [Médico](https://doc.jeedom.com/dev/es_ES/plugin_template).
