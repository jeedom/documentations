...
For it to take on its full meaning, it is necessary on each object, to configure the summaries and a background image : [See abstracts documentation.](/concept/en_US/summary)
