...
| | | | |
|--- | --- | --- | ---|
|<img src="lightmanager/lightmanager_icon.png" class="pluginLogo" width="100" />|Lichtmanagement|Plugin zum Verwalten von Lichtern|[Dokumentation Stall](lightmanager/index.md) - [Beta-Dokumentation](lightmanager/beta/index.md)<br/>[Markt](https://market.jeedom.com/index.php?v=d&p=market_display&id=4199)<br/>[Änderungsprotokoll stabil](lightmanager/changelog.md) - [Changelog-Beta](lightmanager/beta/changelog.md)|
|<img src="sunshutter/sunshutter_icon.png" class="pluginLogo" width="100" />|Verschlussmanagement|Mit diesem Plugin können Sie die automatische Positionierung Ihrer Rollläden je nach Sonne und/oder anderen Bedingungen einfach verwalten. Wichtig : Dieses Plugin funktioniert nur mit Geräten, die über einen Aktions-/Cursorbefehl verfügen, mit dem der Verschluss bei einem bestimmten Öffnungs-/Schließprozentsatz positioniert werden kann.|[Dokumentation Stall](sunshutter/index.md) - [Beta-Dokumentation](sunshutter/beta/index.md)<br/>[Markt](https://market.jeedom.com/index.php?v=d&p=market_display&id=3793)<br/>[Änderungsprotokoll stabil](sunshutter/changelog.md) - [Changelog-Beta](sunshutter/beta/changelog.md)|
