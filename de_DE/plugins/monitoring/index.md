...
| | | | |
|--- | --- | --- | ---|
|<img src="jeeDashboardPublish/beta/jeeDashboardPublish_icon.png" class="pluginLogo" width="100" />|JeeDashboard-Publish|ACHTUNG Plugin nur in der Beta verfügbar<br/>Plugin, mit dem Sie Werte von Jeedom in MQTT veröffentlichen können|[Beta-Dokumentation](jeeDashboardPublish/beta/index.md)<br/>[Markt](https://market.jeedom.com/index.php?v=d&p=market_display&id=4482)<br/>[Changelog-Beta](jeeDashboardPublish/beta/changelog.md)|
