...
| | | | |
|--- | --- | --- | ---|
|<img src="monitoring2/monitoring2_icon.png" class="pluginLogo" width="100" />|Überwachung|Plugin für lokale und Fernüberwachung per SSH|[Dokumentation](monitoring2/index.md)<br/>[Markt](https://market.jeedom.com/index.php?v=d&p=market_display&id=3317)<br/>[Änderungsprotokoll](monitoring2/changelog.md)|
