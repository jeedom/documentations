...
|<img src="htmldisplay/htmldisplay_icon.png" class="pluginLogo" width="100" />|HTML-Anzeige|Plugin zum Einfügen von HTML-Code in ein Geräte-Widget (ermöglicht beispielsweise das Erstellen eines eigenen Menüs für Designs)|[Dokumentation](htmldisplay/index.md)<br/>[Markt](https://market.jeedom.com/index.php?v=d&p=market_display&id=3843)<br/>[Änderungsprotokoll](htmldisplay/changelog.md)|
