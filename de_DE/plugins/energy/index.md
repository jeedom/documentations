...
|<img src="enedis/enedis_icon.png" class="pluginLogo" width="100" />|Enedis Linky|Rufen Sie die Informationen des Linky Smart Meters von seinem Enedis-Kundenkonto ab. Bitte beachten Sie, dass Sie unbedingt auf den "professionellen" Teil der Enedis-Website mit Ihren üblichen Kennungen zugreifen müssen (siehe Dokumentation))|[Dokumentation](enedis/index.md)<br/>[Markt](https://market.jeedom.com/index.php?v=d&p=market_display&id=4036)<br/>[Änderungsprotokoll](enedis/changelog.md)|
...
|<img src="mpower/mpower_icon.png" class="pluginLogo" width="100" />|Mpower|Mit diesem Plugin können Sie Ihre Mpower-Mehrfachbuchsen steuern. Mit dem Widget können Sie alle Informationen anzeigen : Zustand Stromverbrauch Stromspannung und Leistungsfaktor Die Daten werden jede Minute und nach einer Aktion von jeedom aktualisiert. Nur am 6-Steckdosen-Modell getestet|[Dokumentation](mpower/index.md)<br/>[Markt](https://market.jeedom.com/index.php?v=d&p=market_display&id=2181)<br/>[Änderungsprotokoll](mpower/changelog.md)|
