Im Untermenü Plugins-Verwaltung können Sie Plugins bearbeiten, außer
 : Laden Sie sie herunter, aktualisieren und aktivieren Sie sie usw
...
-   **** : Ermöglicht den direkten Zugriff auf die Seite von
    Plugin-Dokumentation

-   **** : ermöglicht das Anzeigen des Änderungsprotokolls des Plugins, falls vorhanden
...
-   **** : Entfernen Sie das Plugin aus Ihrem Jeedom. Sei vorsichtig, das
...
-   **** : Ermöglicht das Aktivieren oder Deaktivieren des Plugins

-   **Jeedom Version** : Minimale Jeedom-Version erforderlich
    für den Betrieb des Plugins

-   **** : Gibt die Lizenz des Plugins an, die im Allgemeinen sein wird
    AGPL
...
-    : Alle Freiheit überprüft alle 5 Minuten, ob in den letzten X Minuten mindestens ein Plugin-Gerät kommuniziert hat (wenn Sie die Funktionalität deaktivieren möchten, geben Sie einfach 0 ein)
...
-   **** : in der Regel wird lokal sein

-   **** : wird Ihnen sagen, ob die Abhängigkeiten OK oder KO sind

-   **** : wird installiert oder neu installiert
...
-   **** : wird dir sagen, ob der Dämon in Ordnung oder KO ist

-   **** : wird in Ordnung sein, wenn alle Kriterien für den Dämon
...
-   **** : alle 15 Minuten ein Cron

-   **** : alle 30 Minuten ein Cron

-   **** : eine Cron pro Stunde
...
-   **** : ermöglicht es Ihnen, nach einem Plugin zu suchen (im Namen oder
    Beschreibung davon)
...
-   4 Aktionen :
    ...
    -   **** : Wenn das Plugin derzeit installiert ist, ist dies
