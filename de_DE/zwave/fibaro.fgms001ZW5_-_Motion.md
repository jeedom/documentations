...
Nach der Aufnahme müssen Sie die zwave+-Konfiguration über das Dropdown-Menü anwenden, Sie sollten diese erhalten :

![Plugin Zwave](images/fibaro.fgms001zw5/information.jpg)

### Commandes

Sie müssen einmal auf die Lupe klicken, um die Modulbefehle aufzurufen. Sobald das Modul erkannt wird, sind die dem Modul zugeordneten Befehle verfügbar.
...
-   12: nur ändern, wenn Sie wissen, warum Sie es tun (z. B. Zuordnung zu einem Modul)
-   14: idem
-   16: idem
...
-   62: gibt die Häufigkeit der Temperaturmessung an (empfohlener Wert 900)
...
> **Tipp**
>
> Dieses Modul hat fünf Assoziationsgruppen, Sie müssen den Controller auf 1, 4 und 5 hinzufügen und 3 entfernen.

Die Namen der Gruppen der Z-Wave+ Version lauten wie folgt:

-   1 : Lifeline, Feedback zum Modulstatus. Der Hauptcontroller sollte dieser Gruppe hinzugefügt werden.
-   2 : Bewegung, Bewegungssensor.
-   3 : Manipulations-, Sabotagealarm.
-   4 : Motion BC, Bewegungssensor. Diese Gruppe zielt darauf ab, die Abwärtskompatibilität mit Controllern sicherzustellen, die das Z-Wave+-Protokoll nicht unterstützen.
-   5 : Tamper BC, Sabotagealarm. Diese Gruppe zielt darauf ab, die Abwärtskompatibilität mit Controllern sicherzustellen, die das Z-Wave+-Protokoll nicht unterstützen.
