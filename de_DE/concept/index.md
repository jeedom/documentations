...
- Auf dem [Dashboard](/de_DE/core/4.1/dashboard)
- Auf dem [Synthese](/de_DE/core/4.1/overview) (v4.1)
- Auf einem [Anzeigen](/de_DE/core/4.1/view)
- Auf einem [Design](/de_DE/core/4.1/design)
- Auf einem [Design 3D](/de_DE/core/4.1/design3d)

![Synthese](images/concept-synthese.jpg)

Diese können in einem Browser auf einem Desktop-Computer oder auf einem Smartphone mit der WebApp oder einer mobilen Anwendung angezeigt werden : [Mobile Version](/de_DE/mobile/index")
...
> Tips
>
> In **Einstellungen → Einstellungen** Sie können festlegen, für welches Objekt Sie im Dashboard ankommen möchten. [Einstellungen](/de_DE/core/4.1/profils)
...
Um mit unserer Hausautomation interagieren zu können, benötigen Sie Befehle ! Es gibt zwei Arten :
...
Diese Befehle können protokolliert werden, um diese Informationen über die Zeit in Form einer Kurve zu erhalten : [Geschichte](/de_DE/core/4.1/history)
...
![Bestellungen](images/concept-commands.jpg)

Diese beiden Arten von Steuerungen sind in Form von Geräten angebracht. Das Gerät verfügt daher über Info- und / oder Aktionsbefehle. Dieses Gerät verfügt über ein übergeordnetes Objekt, mit dem Sie es an der gewünschten Stelle anzeigen können.
...
Diese Geräte werden von Plugins erstellt. Mit dem Z-Wave-Plugin können Sie beispielsweise Ihren Z-Waze-Plug einbinden, wodurch ein Gerät mit seinen Steuerelementen erstellt wird, das Sie benennen und mit einem Objekt verknüpfen können.
...
![Bestellungen](images/concept-equipment.jpg)

## Conclusion

Unabhängig von Ihrem Gerät wird es in Form von Geräten erstellt, aus a [Plugin](/de_DE/core/4.1/plugin).

Dieses Gerät verfügt über eigene Befehle *info* wo *action*. Diese Befehle werden als Widgets angezeigt, die die Gerätekachel in ihrem übergeordneten Objekt bilden.
