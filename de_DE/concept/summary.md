...
- **Zahl ausblenden, wenn Null** : Ermöglicht das Ausblenden des Zusammenfassungswerts, nur wenn er 0 ist. Wir können also wünschen, dass das Symbol für offene Rollläden mit ihrer Nummer und das Symbol für geschlossene Rollläden ohne die Nummer angezeigt wird, wenn alle Rollläden geschlossen sind.
...
> Tip
>
> Sie können auch die Reihenfolge ändern, in der die Zusammenfassungen angezeigt werden, indem Sie mit der Maus eine Zeile nach oben oder unten ziehen.
