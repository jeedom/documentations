...
Diese rein schnittstellenorientierten Inhaltsdateien können auf Kernfunktionen (`/core/class`-Klassen) direkt in PHP oder in js unter Verwendung von js-Klassen (`/core/js`) über Ajax-Aufrufe (`/core/ajax`).
...
Aus Gründen der Rückwärtskompatibilität für Plugins werden alte Funktionen noch deklariert und werden in einer späteren Version veraltet sein. [Siehe die Liste hier](https://github.com/jeedom/core/blob/alpha/desktop/common/js/utils.js#L1423).
