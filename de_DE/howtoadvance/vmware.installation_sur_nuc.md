Hier ist ein Tutorial zum Installieren von VMware auf einem  (Gen6). Wir
...
> [KB](https:?language = en_US & cmd = displayKC & externalId = 2147650). Achtung, diese Manipulation ist in VMware 6.7 nicht mehr durchzuführen
...
Wählen Sie hier die der  entsprechende Festplatte aus (Sie können
...
[tutoriel](https://jeedom.github.io/documentation/howto/de_DE/doc-howto-vmware.creer_une_vm.html)
