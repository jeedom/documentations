...
Hier (plugin *JeeLog*) Cron- und Protokollparameter werden im normalen Modus ausgeblendet, aber im Tabellenmodus rechts sichtbar. Sie können sich auch von den Core v4-Seiten inspirieren lassen.2, insbesondere die der Szenarien, die die Schaltfläche zum Öffnen der Protokolle anzeigt.
