...
Diese Funktion basiert vollständig auf CSS und erfordert keine Modifikation der DOM-Elemente, außer der Hinzufügung der Schaltfläche rechts neben der Suche, um zwischen Tabellen- und Normalmodus zu wechseln.
...
Fügen Sie einfach diese Schaltfläche rechts neben dem Suchfeld auf Ihrer Seite `myplugin/desktop/php/myplugin.php` :
...
> Warnung : Pre-4 Kerne.2 habe nicht die lib **Schieberegler** !
