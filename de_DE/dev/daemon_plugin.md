...
Das erste Argument: `jeedom::getTmpFolder(__CLASS__) . '„/dependence“ ist die Datei, die verwendet wird, um den Fortschritt der Installation zu verfolgen (der Prozentsatz, der während der Installation auf dem Bildschirm angezeigt wird)).
