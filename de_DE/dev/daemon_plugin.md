...
Wir werden uns daher das von Jeedom vorgeschlagene Skelett eines Dämons im Detail ansehen und die Datei „Dämond“ öffnen.py` und wir beginnen mit den letzten Zeilen, die eigentlich den Anfang des Programms darstellen:
...
Und um dies zu bewältigen, ist im Kern von Jeedom erneut alles geplant, um uns mit zwei unterschiedlichen Methoden zu helfen:
...
Wenn sie beispielsweise im Verzeichnis „/resources“ abgelegt wird, wird diese Datei in der Datei von Jeedom angezeigt:
