...
Im Vorlagen-Plugin finden Sie die Grundlagen für die Implementierung eines Daemons in Python und dies ist das Beispiel, das wir in dieser Dokumentation verwenden werden. Es steht Ihnen jedoch frei, Ihren Daemon in der Sprache Ihrer Wahl zu entwickeln, vorausgesetzt, er kann auf der ausgeführt werden [Von Jeedom unterstützte Plattformen](/de_DE/compatibility/).
