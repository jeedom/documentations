...
Das Plugin ist dann in der Lage, gelegentlich Informationen abzurufen (z. B. per http-Anfrage) oder alle Arten von Operationen auszuführen, sofern dies in PHP codiert werden kann.
...
Keine Panik, im Kern von Jeedom ist bereits alles geplant, um uns zu helfen, diesen Dämon in die Schranken zu weisen, und wir werden es hier detailliert beschreiben.
...
Im Vorlagen-Plugin finden Sie die Grundlagen für die Implementierung eines Daemons in Python. Dies ist das Beispiel, das wir in dieser Dokumentation verwenden werden. Es steht Ihnen jedoch frei, Ihren Daemon in der Sprache Ihrer Wahl zu entwickeln, vorausgesetzt, er kann auf der ausgeführt werden [Von Jeedom unterstützte Plattformen](/de_DE/compatibility/).
...
Hier angekommen hast du den Dämon in der Info erklärt.json und implementierte die drei notwendigen Methoden, damit der Jeedom-Kern Ihren Daemon starten und stoppen sowie seinen Status anzeigen kann. Die Voraussetzungen sind gegeben.
...
Es empfängt daher ein Array von Werten als Parameter und ist dafür verantwortlich, es an den Daemon-Socket zu senden, der dieses Array daher in der zuvor gesehenen Methode „read_socket()“ lesen kann.
...
kein Beispiel vorhanden; Die Syntax ist ähnlich wie bei anderen Paketen, mit dem Schlüsselwort „composer“.
...
Aber woher kennt der Kern den Status und wie zeigt er ihn im obigen Frame an?? Dank der Funktion „dependancy_info()“, die wir unserer eqLogic-Klasse hinzufügen müssen.
