...
Hier angekommen hast du den Dämon in der Info erklärt.json und implementierte die drei erforderlichen Methoden, damit der Jeedom-Kern Ihren Daemon starten und stoppen sowie seinen Status anzeigen kann. Die Voraussetzungen sind gegeben.
...
Diese Funktion löscht zunächst das Protokoll der vorherigen Installation, sofern vorhanden, und gibt dann den auszuführenden Skriptbefehl und den Speicherort des Protokolls an den Kern zurück.
