...
Um es zu verwenden, müssen Sie die CSS-Klasse hinzufügen *checkContext* Klicken Sie auf die entsprechenden Kontrollkästchen und rufen Sie die Funktion auf ``jeedomUtils.setCheckContextMenu()``
