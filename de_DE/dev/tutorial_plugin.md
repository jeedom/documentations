...
Im Moment haben wir daher 3 Klassen aus dem Kern von Jeedom verwendet : EqLogic, cmd, cron. Gehen Sie zur Info, wir fügen eine vierte mit der Plugin-Klasse in der VDM-Datei hinzu.php, das Sie öffnen und offen lassen, weil wir es bearbeiten werden.
