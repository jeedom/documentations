...
```
{{Name de l'équipement template}}
```

Par

```
{{Name de l'équipement }} 
```
...
wichtig : Le texte entre accolades correspond au texte qui sera traduit si vous poussez le plugin sur le market
