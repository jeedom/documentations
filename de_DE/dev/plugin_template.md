...
- Dateien, die nur als Einstiegspunkt zum Einschließen mehrerer Dateien dienen, sollten mit enden ``.inc.php``
...
Enthält die zusätzlichen PHP-Dateien, habe ich verwendet, um zum Beispiel eine Einschlussdatei zu setzen, wenn Sie natürlich mehrere Klassendateien oder 3rpartys einbinden müssen
