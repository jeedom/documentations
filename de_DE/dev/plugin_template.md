...
- ``core`` : Ordner mit allen internen Arbeitsdateien.
  ...
  - ```` : Ordner mit Dateien .Plugin-Übersetzung json.
...
La deuxième ligne charge votre modal et l'affichage.  : plugin, l'Ich würde de votre plugin, modal, le nom de votre modal sans le php et ensuite les paramètres que vous voulez lui passer
