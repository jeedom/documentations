...
- ``printEqLogic`` das den gesamten Gegenstand des Geräts als Parameter verwendet (nützlich im Falle einer Datenverarbeitung vor deren Wiederherstellung)). Der Aufruf erfolgt bei der Anzeige von Anlagendaten
...
- Um die Batterie (in %) eines Geräts wieder zusammenzubauen, tun Sie dies an diesem Gerät (Jeedom kümmert sich um den Rest und benachrichtigt den Benutzer bei Bedarf) :
