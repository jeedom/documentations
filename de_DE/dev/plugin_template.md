...
Die Liste der Ausrüstungs- und Befehlseigenschaften finden Sie hier (um die JSON-Eigenschaften zu sehen, schauen Sie sich einfach den Getter oder Setter an. Wenn er zwei Parameter benötigt, handelt es sich um JSON)
...
Um die angeforderte Version in ein Dashboard oder eine mobile Version umzuwandeln (mview wird beispielsweise mobil), ermöglicht dies beispielsweise, den Ansichten den Namen der Objekte hinzuzufügen)
