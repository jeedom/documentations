...
Zunächst einmal die Fälle, in denen Sie es verwenden müssen: Wenn Ihre Klasse von eqLogic erbt oder cmd eine toHtml-Funktion hat, lohnt es sich sonst nicht, den Rest zu lesen.
