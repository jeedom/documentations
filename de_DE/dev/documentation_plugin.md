# Wie es geht la documentation d'un plugin
...
Le principe est très simple la documentation du plugin doit etre un simple lien web a indiquer dans votre fichier info.json (voir le détail [ici](https://jeedom.github.io/documentation/dev/de_DE/structure_info_json) ) dans le champs documentation.

A noter que vous avez aussi un champs Änderungsprotokoll qui doit fonctionne de la meme maniere que le champs documentation.
...
- Änderungsprotokoll.md => votre Änderungsprotokoll
