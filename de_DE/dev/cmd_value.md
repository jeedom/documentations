...
|Aktion/Auslöser gedrückt|Schließen des Verschlusses<br/>Starten des Schließens oder Festlegen des minimalen Schiebereglerwerts oder -zustands oder 0|
...
|Allgemeiner Typ  | Werte / Handeln |
|---------------|----------------|
|Aktions-/Tor- oder Garagen-Umschalttaste|Schalter öffnet sich, wenn er geschlossen ist, und schließt, wenn er geöffnet ist<br/>Öffnung bei Blockierung (zur Sicherheit))| 
