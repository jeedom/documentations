...
Sobald Sie hier sind, müssen Sie nur noch aktivieren **Verwenden Sie Jeedom-DNS** dann auf der Linie **Management** machen **Neustarten** und Ihre URL auf der HTTP-Statusebene angezeigt wird, können Sie sie natürlich auf der Marktprofilseite anpassen
...
Einer der wichtigsten Schritte ist das Ändern des Standardpassworts Ihres Jeedom-Kontos. Klicken Sie dazu auf Einstellungen → System → Benutzer:
...
In Jeedom kann es alles und jedes sein, aber es wird empfohlen, dies nach Ihren Münzen zu tun.
