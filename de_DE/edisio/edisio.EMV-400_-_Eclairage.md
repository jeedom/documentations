...
-   Aktivieren Sie : Drücken Sie 4x "R" am Empfänger, um dies durch einen einzelnen Dauerton zu bestätigen
-   Deaktivieren: Drücken Sie 5x "R" am Empfänger, Bestätigung durch 3 einfache Pieptöne.
-   30 Minuten Timer: DIP-Schalter 3 auf
...
> **Wichtig**
>
> Damit sich das Modul im "Beleuchtungs" -Modus befindet, muss der DIP-Schalter 2 eingeschaltet sein
...
Wählen Sie in der Liste der Geräte rechts "Leichtes Mikromodul" aus" :
...
Wir haben zu Beginn dieser Dokumentation darüber gesprochen. Bei bereits versenkten Modulen, in Zwischendecken oder sogar Dachböden. Diese Methode ermöglicht das Hinzufügen eines neuen Senders, ohne auf das "R" des Empfängers zuzugreifen.
