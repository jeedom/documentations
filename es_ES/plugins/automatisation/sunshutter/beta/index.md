...
- **** :
    - **** : Se utiliza para activar el equipo.
...
>* : el sistema cierra el obturador y luego lo abre manualmente unos minutos más tarde, luego la gestión automática solo se realizará si **Recuperar el control** Me senté "****" o que ha pasado el tiempo de recuperación o que la orden **Asumir la gestión** se activa.*
...
>****
>
>Los "modos" mencionados aquí se relacionan con los modos definidos en la pestaña **** de cada equipo de complemento **Gestión de persianas** y no se refiera de ninguna manera a ningún modo de complemento ****.
...
- **** : La latitud del edificio o la contraventana.
- **** : La longitud del edificio o la contraventana.
- **** : La altitud del edificio o la contraventana.
...
- **** : La condición que debe cumplirse para que la regla sea válida *(facultatif)*.
- **** : Si se ingresa, la condición solo será válida si el obturador se encuentra actualmente en el modo especificado. Es posible especificar varios modos separándolos con comas *(facultatif)*.
...
- **** : Marque la casilla para suspender la gestión automática mientras la regla sea válida.
- **** : La posición deseada en porcentaje si la regla es válida *(vacío = sin acción)*.
- **** : Etiqueta asociada a la validación de la regla de excepción *(facultatif)*.
...
- **** : Condición, complementaria a la posición, a cumplir para validar el posicionamiento de la persiana *(facultatif)*.
- **** : Complete los límites de azimut del sol en grados entre los cuales la condición será válida.
- **Elevacion** : Complete los límites de elevación del sol en grados entre los cuales la condición será válida.
- **** : La posición deseada en porcentaje si las condiciones de posicionamiento (y adicionales si aplica) son válidas.
- **** : Etiqueta asociada a la validación de la condición de posicionamiento *(facultatif)*.

![Conditions](../images/sunshutter_conditions.png)

>****
>
>El sitio [](https://www.){:target = "\_ blank"} permite, una vez ingresada su dirección, visualizar la posición del sol y los ángulos de acimut y elevación según las horas del día *(solo arrastra el solito hacia arriba)*.

# Programmation

Esta pestaña solo aparece si el complemento **** está instalado en tu Jeedom. Enumera la programación del complemento **** actuar sobre la gestión automática de este componente para, por ejemplo, planificar una suspensión y una reanudación manual durante las horas de siesta de un niño.
...
- **** : Forzar actualización de pedidos **Azimut del sol**  **Salida del sol**.
>Por supuesto, es posible utilizar los valores de los comandos **Sol azimut**  **Salida del sol** en otros lugares de Jeedom.
...
- **** : Etiqueta correspondiente a una excepción o una condición de posicionamiento válida.
- **** : Suspende la gestión automática de persianas.
- **Suspender (etiqueta)** : Estado actual de la suspensión de la gestión automática de persianas *(Ninguno / Manual / Automático)*.
- **** : Forzar el reinicio de la gestión automática.
>Este es el comando que debe ejecutarse para volver a la gestión automática si ha cambiado la posición de su persiana manualmente y configurado **Recuperar el control** en "****".

- **** : Modo de obturador actual.
...
>****
>
>Puede, por ejemplo, definir un modo **** y un modo **** y ajuste la apertura y el cierre de su persiana de acuerdo con estos 2 modos.

# Santé

El complemento **Gestión de persianas** tiene una ventana ****, en la página de equipamiento general, que le permite ver de un vistazo las configuraciones de cada gestión automática.
