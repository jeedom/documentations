...
| | | | |
|--- | --- | --- | ---|
|<img src="monitoring2/monitoring2_icon.png" class="pluginLogo" width="100" />|Monitoreo|Complemento de monitoreo local y remoto por SSH|[Documentación](monitoring2/index.md)<br/>[Mercado](https://market.jeedom.com/index.php?v=d&p=market_display&id=3317)<br/>[Cambios](monitoring2/changelog.md)|
