...
| | | | |
|--- | --- | --- | ---|
|<img src="jeeDashboardPublish/beta/jeeDashboardPublish_icon.png" class="pluginLogo" width="100" />|JeeDashboard-Publish|ATENCIÓN complemento solo disponible en versión beta<br/>Complemento que le permite publicar valores de Jeedom en MQTT|[Documentación beta](jeeDashboardPublish/beta/index.md)<br/>[Mercado](https://market.jeedom.com/index.php?v=d&p=market_display&id=4482)<br/>[Lista de cambios beta](jeeDashboardPublish/beta/changelog.md)|
