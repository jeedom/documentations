...
|<img src="unifiprotect/beta/unifiprotect_icon.png" class="pluginLogo" width="100" />|Ubiquiti Unifi proteger|El complemento ATENCIÓN está disponible solo en versión beta<br/>Ubiquiti Unifi proteger|[Documentación beta](unifiprotect/beta/index.md)<br/>[Mercado](https://market.jeedom.com/index.php?v=d&p=market_display&id=4188)<br/>[Lista de cambios beta](unifiprotect/beta/changelog.md)|
