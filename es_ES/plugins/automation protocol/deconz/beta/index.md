...
>****
>
> Este complemento requiere una llave USB [](http://bit.ly/2n4VyWc)
...
Aquí encontrará la lista de módulos compatibles con deconz [](https://phoscon.de/en/conbee/compatible)
...
Para la instalación remota aquí está el [](https://phoscon.de/en/conbee/install)
...
Al restaurar una copia de seguridad de Jeedom, el equipo se restaura pero no se adjunta a la clave, puede que tenga que reinstalar la clave. Para hacer esto, necesitará la copia de seguridad mencionada anteriormente.  ``plugins/deconz/data``  ``.tar.gz``  ``.dat``. 
...
Seguir [](https://www.dresden-elektronik.de/rpi/deconz-firmware/?C=M;O=D) y verifique si hay un nuevo firmware, en caso afirmativo, recupere
...
>**Tengo el error &quot;Error durante la solicitud : .1:8484 / api / 931559A482 / sensores (POST), datos : error nulo : 1 => usuario no autorizado"**
>
