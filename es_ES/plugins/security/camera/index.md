...
-   ID de pedido (use con comandos de tipo de información para, por ejemplo, llevar la información de movimiento de la cámara a Jeedom a través de la API, consulte a continuación)
...
Este comando algo específico permite seguir la captura para enviarla (compatible con el complemento de holgura, correo y transferencia).
