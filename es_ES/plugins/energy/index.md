...
|<img src="enedis/enedis_icon.png" class="pluginLogo" width="100" />|Enedis Linky|Recupere la información del medidor inteligente Linky de su cuenta de cliente de Enedis. Tenga en cuenta que es fundamental tener acceso a la parte "profesional" del sitio de Enedis con sus identificadores habituales (consulte la documentación)|[Documentación](enedis/index.md)<br/>[Mercado](https://market.jeedom.com/index.php?v=d&p=market_display&id=4036)<br/>[Cambios](enedis/changelog.md)|
