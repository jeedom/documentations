...
## Configuración de resumen general
...
- **Si el icono es nulo** : Icono de resumen si su valor es 0. Le permite especificar un icono diferente, como un obturador cerrado, una luz apagada o un color diferente, etc.
...
- **Ocultar número si es cero** : Le permite ocultar el valor de resumen, solo si es 0. Por lo tanto, podemos desear tener el icono de la contraventana abierto con su número y el icono de la contraventana cerrado sin el número cuando todas las contraventanas estén cerradas.
- **Método de conteo** : Si cuenta un dato binario, entonces debe poner este valor en binario, por ejemplo, si cuenta el número de lámparas encendidas pero solo tiene el valor del atenuador (0 a 100), entonces debe poner binario, así Jeedom considera que si el valor es mayor que 1, entonces la lámpara está encendida.
...
Normalmente, ahora debería haber creado algunos resúmenes sobre sus objetos y, por lo tanto, tener información sobre sus objetos y en el resumen global, como sus contraventanas abiertas, sus luces, etc.
...
Por lo tanto, ahora podemos usarlo como cualquier información o acción de un equipo real, en un escenario !
