...
- **lanzamiento** : Release Candidate rama de V3. Solo para corrección de errores.
...
- **núcleo** : Carpeta que incluye funciones internas principales:
...
- **pag** : Página para mostrar. Aquí, `panel de control`.
