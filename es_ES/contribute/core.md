...
- **escritorio** : Carpeta que incluye todas las páginas mostradas (la interfaz) en el escritorio y sus funciones.
	...
	- CSS : Archivos css específicos de la pantalla de escritorio.
...
El archivo `/escritorio/php/index.php` también se encarga de :
...
Las funciones internas del Core están así bien separadas, para la operación interna (Back-end), pero son accesibles por la interfaz. Del mismo modo, cada página tiene su propio código php y js. Esto permite evolucionar y mantener mejor el código, pero también optimizar el rendimiento al cargar solo las clases y funciones necesarias.
