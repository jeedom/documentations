...
Bloquea y desbloquea con el botón, la función TwistAssist o usando tu smartphone. Y con la función de desbloqueo automático, la cerradura Danalock desbloquea automáticamente la puerta cuando te acercas a tu casa y la bloquea justo después de que regresas.
...
Amplíe el control de su hogar inteligente con Danalock, el iniciador perfecto para todos los controles de su hogar. El Danalock funciona a la perfección con otros dispositivos domésticos inteligentes, y todas las comunicaciones están fuertemente encriptadas: nadie puede piratear su hogar.
