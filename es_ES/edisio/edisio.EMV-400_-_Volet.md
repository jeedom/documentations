...
![Órdenes](images/emv.400/commande.jpg)

Aquí está la lista de comandos :

-   Estado : Es el comando que simula el retorno del estado.

-   Subir : Este es el comando que abre el obturador

-   Para : Es el comando que hace posible detener el movimiento del obturador.
...
![Órdenes](images/emv.400/infos_moteur.jpg)
...
> **Note**
>
> No es necesario asociar el comando "Stop", ya está hecho
> automáticamente.

Método remoto 
----------------

Hablamos de esto al comienzo de esta documentación, en el caso de
