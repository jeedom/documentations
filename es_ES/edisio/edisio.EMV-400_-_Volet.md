...
de 2 sorties Marche/Arrêt ou d'un volet roulant Ouvrir/Detener/Fermer.
...
-   Mode d'usage: Marche/Arrêt, Ouvrir/Detener/Fermer
...
-   Estado : C'est la commande qui permet de simuler le retour d'état

-   Monter : C'est la commande qui permet d'ouvrir le volet

-   Detener : C'est la commande qui permet de stopper le mouvement du volet
