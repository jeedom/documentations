...
> centralizar el equipamiento de la **Jeedom(s) Source(s)**\
> Las capturas de pantalla en un fondo negro corresponden a la **Jeedom Target**.\
> \
> - **Jeedom Fuente** : Servidor (su ex esclavo (s) Jeedom)
> lo que vuelve a poner su equipo en el **Jeedom Target**.\
> \
> - Las nociones de **Jeedom Maître** y **Jeedom Esclavo** ya no son
...
> posible tener múltiples **Jeedom Cibles** por lo mismo **Jeedom
...
-   Actualiza el **Jeedom Maître** a la última versión (incluso si
    no se le ofrece ninguna actualización).

-   Actualizar complementos de **Jeedom Maître** hasta el final
    versiones disponibles.

-   Compruebe en la página de Salud que la configuración de red interna del
    **Jeedom Maître** está bien (y externo si su **Jeedoms Sources**
    será distante).

Recopilando información útil 
-------------------------------------

Dependiendo de los complementos instalados en su **Jeedom Esclavo**, El es
necesario para recuperar la siguiente información :

### Complemento Zwave 

-   En la página de salud del complemento Zwave en el **Jeedom Maître**, choisir
    suyo **Esclavo** desde el menú desplegable y hacer una captura de pantalla,
    esto para tener una lista del equipo que viene
    de este.

-   Nota para cada equipo proveniente de **el esclavo** : l'objet
    padre, nombre, ID (nodo), modelo.

-   Recuperar archivo Zwcfg : *Complementos ⇒ Gestión de complementos ⇒
    Onda Z*. Haga clic en el botón rojo *Zwcfg* y copier le contenu
...
-   Hacer una copia de seguridad
    ...
    de su **Jeedom Maître** y tu **Jeedom Esclave(s)**
...
> instalando un nuevo **Jeedom Fuente** en paralelo sin tener que
> toca tu **Jeedom Esclavo** existente. Obviamente moviéndose
...
> **Jeedom Esclavo**, le recomendamos que use una tarjeta
...
-   Instale un nuevo Jeedom en una nueva tarjeta SD (Let it be
    poner en tu **Jeedom Esclavo** existente o para un
...
-   Actualiza el **Jeedom Fuente** a la última versión (incluso si
    no se le ofrece ninguna actualización).

-   Verifique en la página de Salud que la configuración de la red interna (y
    externo si es necesario) **Jeedom Fuente** esta bien.
...
-   Recrea el árbol de objetos (solo los que
    ...
    **Jeedom Fuente** (Ex esclavo).

Configuración de equipos en el **Jeedom Fuente** 
------------------------------------------------------

Para enviar equipos presentes en el **Jeedom Fuente**
...
> información de cada equipo en el **Jeedom Fuente** afin
...
> objetos recreados en el **Jeedom Fuente** para que sean más tarde
...
-   Reemplazar archivo *Zwcfg* : *Complementos ⇒ Gestión de complementos ⇒
    Onda Z*. Haga clic en el botón rojo *Zwcfg* y coller le contenu du
...
El complemento "Jeedom Link" instalado en el **Jeedom Fuente** permitirá el
...
> a través del equipo de un **Jeedom Fuente** transferido a través de
...
-   Eliminar el equipo residual de la antigua **Jeedom Esclavo**.
...
-   En la página de Jeedom Network, elimine la anterior **Jeedom Esclavo**.
