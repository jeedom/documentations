...
> \
> - **jeedom Source** : Serveur (suyo/vos ancien(s) jeedom Esclave(s))
...
-   Dans la page santé du plugin Zwave sur le **jeedom Maître**, choisir
    suyo **Esclave** dans le menu déroulant et faire une copie d'écran,
    ceci afin de disposer d'une liste des équipements qui viennent
    de celui-ci.

-   notar pour chaque équipement venant de **l'Esclave** : l'objet
...
-   Faire une [sauvegarde
    ...
    de suyo **jeedom Maître** et de suyo (vos) **jeedom Esclave(s)**
    et récupérer celle(s)-ci sur suyo PC/NAS…​.
...
-   Faire une [sauvegarde
    ...
    de suyo **jeedom Maître** et de suyo (vos) **jeedom Esclave(s)**
    et les récupérer sur suyo PC/NAS…​.
...
-   Installer un nouveau jeedom sur une nouvelle carte SD (Que cela soit
    pour mettre dans suyo **jeedom Esclave** existant ou pour un
...
-   Configurer suyo compte jeedom Market (*Configuration ⇒ Mises à jour
...
-   Pas de solution facile à ce niveau, il faudra avoir deux
    onglets/fenêtres d'ouverts sur suyo navigateur.
