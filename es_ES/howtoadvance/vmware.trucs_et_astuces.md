...
> **Importante**
>
> Si pasas por el proxy inverso del NAS la consola en modo web de las VMs no funciona (porque pasa por el websocket), en cambio si pasas por VMware Remote Console todo debería estar bien (pasa por puerto 902)
