...
Voici les Comandos à lancer pour installer letsencrypt avant la
génération :
...
> Comando **a2dissite default-ssl.conf** Pensez à reporter le code par
...
Cette Comando n'est à utiliser que si vous disposez d'un serveur web
Nginx.
...
Le renouvellement se fait avec la Comando :

    /opt/letsencrypt/letsencrypt-auto --apache --renew-by-default -d mondomaine.fr

Vous recevez un mail automatiquement à l'arrivée de l'échéance du
certificat qui vous rappellera de lancer cette Comando.
