...
```
{{Nombre de l'équipement template}}
```

Par

```
{{Nombre de l'équipement }} 
```
...
importante : Le texte entre accolades correspond au texte qui sera traduit si vous poussez le plugin sur le market
