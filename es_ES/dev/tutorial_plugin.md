...
Por lo tanto, es necesario crear un comando de tipo info para almacenar esta información. Elle sera de sous-amable « string » car c'est une chaîne de caractère.
...
Es mejor pero el widget aún toma el ancho del tablero. Por lo tanto, corregiremos. Mediante défaut la largeur du widget de l'équipement(eqLogic) et la hauteur sont à « auto ».
