...
El registro de cambios, la documentación, el idioma y la compatibilidad son una mierda en este momento. Volveré a eso más tarde
...
Luego podrás cambiar la frecuencia del cron dependiendo de la importancia de tu información para recuperar.
...
Por lo tanto, cambiaremos el ancho del widget (equipo => eqLogic) usando el método setDisplay() heredado de la clase eqLogic .Dejamos la altura en auto.
...
Por el momento, hemos utilizado 3 clases del núcleo de jeedom : EqLogic, cmd, cron. Vaya para obtener información, agregamos un cuarto con la clase de complemento en el archivo vdm.php que abres y dejas abierto porque lo vamos a editar.
