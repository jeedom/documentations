...
|Tipo genérico  | Valores/Acción |
|---------------|----------------|
|Botón de alternar acción/puerta o garaje|Interruptor de apertura si está cerrado y de cierre si está abierto<br/>Apertura si está bloqueada (por seguridad))| 
