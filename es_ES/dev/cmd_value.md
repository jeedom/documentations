...
||Luminosité<br/><br/>()<br/>Siempre utilice con Light State en comando binario|
...
|  |  |
|---------------|----------------|
|Sección de información/estado|Si binario :<br/><br/><br/> :<br/> <br/><br/> :  !|
...
|Deslizador de botón de acción/en blanco|Indique la proporción de apertura de la persiana<br/>:<br/>Los valores mínimos y máximos son obligatorios|
...
|Panel de información/estado con inclinación vertical|Ángulo 0->90° (mediante deslizador))|
...
|  |  |
|---------------|----------------|
|Información/Válvula<br/><br/>Etat|0 = Apagado<br/>1 = Encendido|
...
|  |  |
|---------------|----------------|
|Información/Puerta<br/><br/>()|0 = Contacto (Cerrado))<br/>1 = Sin contacto (Abierto))| 
...
|Modo de información/alarma|Etiqueta que muestra **** el nombre de un comando de modo de acción/alarma|
|Alarma de acción/activada|Activa la alarma|
|Acción/Alarma publicada|Desactivar la alarma|
...
|Información/Estado del termostato (HUMANO))|'apagado o detenido o parar'<br/>''<br/>''<br/><br/>| 
||'<br/>'<br/>Etiqueta que muestra **** |
|||
|||
||| 
||| 
