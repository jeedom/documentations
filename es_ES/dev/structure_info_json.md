...
``description`` *            | Descripción del complemento, tal como aparecerá en Jeedom Market. Mínimo 80 caracteres. (``<br/>`` para nueva línea.). Tenga en cuenta que esta es una tabla para los diferentes idiomas de jeedom posibles (observe bien el ejemplo del complemento de plantilla))                                  |                                                                                     |
