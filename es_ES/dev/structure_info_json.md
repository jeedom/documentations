...
Aquí, este atributo permite definir un parámetro para cada equipo jeedom (en la configuración avanzada del equipo). Puede encontrarlo en la configuración del equipo en `plugin::mqtt2::mqttTranmit` (`complemento::id_plugin::key`)
