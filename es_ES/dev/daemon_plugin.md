...
> **Atención**
>
> debes adaptar este método y eliminar el código que no sea necesario en tu caso, en particular el try/except en `jeedom_serial.close()` si no usas esta clase.
