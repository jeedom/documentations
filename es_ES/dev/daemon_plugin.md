...
Nuevamente, no está obligado a usar este mecanismo, es libre de crear otra cosa (servidor http, por ejemplo) pero es lo que proporciona Jeedom básico, es liviano y funciona muy bien.
