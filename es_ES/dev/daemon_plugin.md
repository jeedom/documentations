...
Veremos más adelante el uso de `hasDependency` y `maxDependencyInstallTime`.
...
Tenga en cuenta que comenzamos por detener el daemon, esto para administrar el reinicio.
