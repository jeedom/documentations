...
Estas modificaciones aún se admiten en la versión v4.2 y pasará a **Obsoleto** en una versión futura.
...
*Estos dos métodos también se integraron en la versión v4.1 para acelerar su adopción.*

- Eliminación de la biblioteca JWERTY en favor de vanillaJS (gestión de atajos de teclado)).
- El uso de `showAlert` cambia : `$('#div_alert').showAlert({` se convierte en `$.fn.showAlert({`. No hay cambios para las llamadas desde un modal. No compatible con versiones Core anteriores a 4.2.
