...
| | | | |
|--- | --- | --- | ---|
|<img src="gardena/gardena_icon.png" class="pluginLogo" width="100" />|Gardena-Husqvarna|Complemento que permite integrar todos los dispositivos de la gama Gardena Smart System (Water Control, sensor, control de riego, toma de corriente y cortacésped Sileno) que le permite controlar su sistema de riego y su robot cortacésped, así como los robots Husqvarna Automower Connect. Es posible acceder a los datos del dispositivo, monitorearlos y realizar ciertas acciones dependiendo del dispositivo (ver la documentación).|[Documentación estable](https://mips2648.github.io/jeedom-plugins-docs/gardena/es_ES/) - [Documentación beta](https://mips2648.github.io/jeedom-plugins-docs/gardena/beta/es_ES/)<br/>[Mercado](https://market.jeedom.com/index.php?v=d&p=market_display&id=4031)<br/>[Registro de cambios estable](https://mips2648.github.io/jeedom-plugins-docs/gardena/es_ES/changelog) - [Registro de cambios Beta](https://mips2648.github.io/jeedom-plugins-docs/gardena/beta/es_ES/changelog)|
