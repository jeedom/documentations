...
> **Important**
>
> Debian 10 (Buster) es la distribución oficialmente compatible para la versión 3.1.7 de Jeedom (pero Jessie / stretch sigue siendo perfectamente funcional). Si no tiene un comando mínimo de entornos Linux, le recomendamos que comience con un Smart.
