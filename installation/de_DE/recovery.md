...
Die neuen Funktionen zur Wiederherstellung des Systems können nicht auf einem Smart installiert werden, auf dem noch Debian 10 läuft. In diesem Fall muss zunächst das austauschbare eMMC-Laufwerk beschrieben werden, um auf eine neuere Debian-Version umzusteigen; siehe Dokumentation [**Anleitungen → Tutorials → Smart auf Werkseinstellungen zurücksetzen**](../../howto/de_DE/smart.md) Weitere Informationen finden Sie hier.
