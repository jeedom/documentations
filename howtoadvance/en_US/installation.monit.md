...
Monit is a service monitoring tool. It ensures that a service is always running.

To do this, we provide it with the evaluation criteria and the actions to be taken.
