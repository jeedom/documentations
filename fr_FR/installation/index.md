...
[**Les boxes officielles Jeedom**](../compatibility/index#boxes-officielles) garantissent une pleine compatibilité quelles que soient les évolutions logicielles futures.

Jeedom peut également être installé sur [tout matériel supporté](../compatibility/index#matériels-supportés) prenant en charge le système [**Linux Debian en version actuellement recommandée**](../compatibility/index#Debian).
