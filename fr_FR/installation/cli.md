...
>**INFORMATION**
>
>En cas d'interrogation concernant l'installation de Debian, l'équipe Jeedom propose également des images systèmes incluant Debian et Jeedom préinstallé. Consulter [**la documentation dédiée**](../compatibility/index#images-système-officielles) pour plus de détails.
...
Une fois connecté au système avec un utilisateur bénéficiant des droits `sudo`, il suffit de taper ces 3 commandes :
