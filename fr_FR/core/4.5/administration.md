...
- **Taille maximale pour fichier de log (en Mo)** : Définit la taille maximale d'un fichier de Log. Toutes les heures, les logs dépassant cette taille seront tronqués, pour ne garder que le nombre de lignes maximum définie. 
