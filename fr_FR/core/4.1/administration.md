...
Pour chaque clé API de plugin vous pouvez leur interdire les méthodes core (général) pour les limiter à leur seule méthode embarquée (attention certain plugin comme mobile ou jeelink ont absolument besoin des méthodes core)
