...
Le code est réparti dans différents répertoires à la racine de Jeedom *(`/var/www/html` par défaut)* :
...
- En Mobile :
	- `mobile/css/mobile.main.css` : CSS principal de l'interface.
	- `mobile/css/coreWidgets.css` : CSS propres aux widgets du Core.
