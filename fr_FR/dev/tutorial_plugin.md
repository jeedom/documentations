...
```
{% raw %}{{Ajouter un template}}{% endraw %}
```

Par

```
{% raw %}{{Ajouter un équipement}}{% endraw %}
```
...
```
{% raw %}{{Nom de l'équipement template}}{% endraw %}
```

Par

```
{% raw %}{{Nom de l'équipement}}{% endraw %}
```
...
Et renommez les fonctions comme suit
