...
Plugin servant à piloter une clé blink(1)Le plugin Ikea permet d’établir un lien avec la passerelle Ikea Tradfri. Vous pourrez controller vos lumières,prises et store Ikea et avoir un retour d'état temps réel.Plugin pour commander le KarotzPlugin permettant de contrôler les ampoules LifxPlugin pour commander le Nabaztag| | | | |
|--- | --- | --- | ---|
