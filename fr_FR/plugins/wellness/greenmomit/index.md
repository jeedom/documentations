...
![greenmomit Install 1](./greenmomit_Install_1.png)

Cliquer sur "Général", puis Plugins

![greenmomit Install 2](./greenmomit_Install_2.png)

Cliquer sur l’icône "Market" pour accéder au contenu des plugins
disponibles sur le Market Jeedom.

![greenmomit Install 3](./greenmomit_Install_3.png)
...
![greenmomit Install 4](./greenmomit_Install_4.png)

Vous aurez la possibilité d’installer le plugin dans sa version ![commun
1](./commun_1.png) stable ou ![commun 2](./commun_2.png)
...
![greenmomit ST](./greenmomit_ST.png)
...
![greenmomit Config 1](./greenmomit_Config_1.png)
...
![greenmomit Config 3](./greenmomit_Config_3.png)
...
![greenmomit Widget 1](./greenmomit_Widget_1.png)Le widget du thermostat est déjà en place et disponible dans l’objet parent définit dans la configuration précédente.

![greenmomit Widget 2](./greenmomit_Widget_2.png)

![commun 1](./commun_1.png)Température actuelle (sonde du thermostat). 

![commun 2](./commun_2.png)Hydrométrie actuelle (sonde du thermostat).

![commun 3](./commun_3.png)Eteint le thermostat si le thermostat détecte que c’est la nuit.

![commun 4](./commun_4.png)Le thermostat apprend tout seul vos habitudes.

![commun 5](./commun_5.png)Le thermostat s’arrête automatiquement s’il ne détecte pas de présence.  

![commun 6](./commun_6.png)Mettre le thermostat en mode Manuel ou Automatique.  

![commun 7](./commun_7.png)Etat du thermostat.  

![commun 8](./commun_8.png)Consigne du thermostat. Modification de la consigne avec la roue.  

![commun 9](./commun_9.png)Rafraîchir l’état. En survolant, affichage de la dernière synchronisation. 
