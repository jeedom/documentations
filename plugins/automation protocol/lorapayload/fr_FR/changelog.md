...
- Ajout des commandes info/action External temperature pour le produit *Milesight WT401*
- Ajout des commandes downlinks pour le produit *Milesight WT401*
- MAj decoder du produit * Dragino ==WQS==-LB - Water Quality Sensor*
- MAj decoder du profuit *ZpMeter - Compteur d'eau LoRaWAN*
- Ajout du produit *mclimate_CO2_PIR_lite - CO2 + PIR Lite LoRaWAN *
- Ajout du produit *Yosensi | YO Pulse - digital pulse counter within DIN rail enclosure*
- Maj decoder *Yosensi | YO Pulse - digital pulse counter within DIN rail enclosure*
- Correction anti-doublons création d'équipement et regénération de commande mqtt
- Correction du décodeur *Mclimate CO2 Display*
- Ajout du produit * NKE - Watteco TEMPO'2 *
- Intégration des historiques Milesight en batch
- Fix decoder *Milesight EM500 SWL*
- Ajout des downlinks de configuration *Adeunis - ARF8170BCA Dry Contacts*
...
- Correction du décodeur *Milesight AT101*
- Ajout du produit *Milesight WT102*
- Ajout du downlink *Set valve opening percentage* pour *Milesight WT101*
- Ajout du produit *Milesight WT401 - Smart Wireless Thermostat*
- Ajout du produit *Dezem Harvy2*
- Ajout du produit *Milesight CTH01*
- Ajout du produit *Milesight EM500SWL*
- Correction du décodeur *mclimate_DisplayCO2*
- Compatibilité avec un LNS externe
- Ajout des commandes pour le *Milesight CTH01*
- Ajout des commandes pour le *Milesight WT401*
- Ajout du produit *Adeunis - Transceiver TIC LoRaWAN ARF8250AA*
- Ajout du produit *Eastron SDM 530*
- Ajout des commandes du *Milesight CTH01*
- Correction du device profile des produits Citylone
- Fix Decoder WoMaster
- Ajout du produit *Milesight UC512 - Smart Irrigation Controller*
- Màj style search bar Panel Lorapayload
- Fix erreur get list application chirpstack
- Màj decoder et encoder Nexelec X2 - X5
- MAJ decoder ZP-Meter
- Fix decoder dragino PS-LB et ==WQS==-LB
- Upgrade decoder Nexelec-X2 et X5
- Fix bug install dependance python Debian 12
- Mise a jour des commande du WoMaster_LR144
