...
> **Important**
>
> In order for the module to be in "Shutter" mode, DIP Switch 2 must be down
...
-   State : This is the command that simulates the status return
-   To go up : This is the command that opens the pane
-   Stop : This is the command that stops the movement of the shutter
-   To come down : This is the command that closes the pane
...
> **Note**
>
> There is no need to associate the "Stop" command, this is done automatically.
...
-   Associate a new transmitter with a receiver with Jeedom already associated :
    -   Output 1 :
        -   Press 1x on "Test" the command "E" in Jeedom, single beep (short in repetition) signals the programming of output 1 activated.
