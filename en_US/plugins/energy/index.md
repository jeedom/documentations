...
|<img src="enedis/enedis_icon.png" class="pluginLogo" width="100" />|Enedis Linky|Retrieve the information of the Linky smart meter from its Enedis customer account. Please note, it is essential to have access to the "professional" part of the Enedis site with your usual identifiers (see the documentation)|[Documentation](enedis/index.md)<br/>[Market](https://market.jeedom.com/index.php?v=d&p=market_display&id=4036)<br/>[Changelog](enedis/changelog.md)|
...
|<img src="mpower/mpower_icon.png" class="pluginLogo" width="100" />|Mpower|This plugin allows you to control your Mpower multiple sockets. The widget allows you to see all the info : State Power Consumption Current Voltage And power factor The data is refreshed every minute and after an action from jeedom Only tested on the 6 outlet model|[Documentation](mpower/index.md)<br/>[Market](https://market.jeedom.com/index.php?v=d&p=market_display&id=2181)<br/>[Changelog](mpower/changelog.md)|
