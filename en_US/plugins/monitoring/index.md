...
| | | | |
|--- | --- | --- | ---|
|<img src="jeeDashboardPublish/beta/jeeDashboardPublish_icon.png" class="pluginLogo" width="100" />|JeeDashboard-Publish|ATTENTION plugin only available in beta<br/>Plugin allowing you to publish values from Jeedom in MQTT|[Beta documentation](jeeDashboardPublish/beta/index.md)<br/>[Market](https://market.jeedom.com/index.php?v=d&p=market_display&id=4482)<br/>[Changelog beta](jeeDashboardPublish/beta/changelog.md)|
