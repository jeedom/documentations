...
Local and remote monitoring plugin by SSHPlugin to retrieve information from inverters via nutPlugin to monitor your 3D print servers| | | | |
|--- | --- | --- | ---|
...
|<img src="nut/nut_icon.png" width="100" />|Inverter (NUT)||[Documentation](nut/index.md) - [Market](https://market.jeedom.com/index.php?v=d&p=market_display&id=1500)|
