...
> **Important**
>
> Debian 10 (Buster) is the officially supported distribution for version 3.1.7 of Jeedom (but Jessie / stretch remains perfectly functional). If you do not have a minimum command of Linux environments, we advise you to start with a Smart.
