...
|Information/State Panel Vertical Tilt|Angle 0->90° (via slider)|
...
|Action/Gate or garage door close button|Fermeture|
...
|Generic type  | Values / Action |
|---------------|----------------|
|Active Status/Info|0 = inactive<br/>1 = active|
