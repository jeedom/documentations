...
|Generic type  | Values / Action |
|---------------|----------------|
|Info/State Siren|0 = Does not ring<br/>1 = Ring|
...
|Generic type  | Values / Action |
|---------------|----------------|
|Info/Portal status open<br/>Info/Garage opening status<br/>(same treatment)|0 = Closed<br/>252 = Closing in progress<br/>253 = Stopped<br/>254 = Opening in progress<br/>255 = Open<br/>(Based on z-wave equipment, could be as binary or labeled ?)|
