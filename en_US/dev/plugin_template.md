# 
 ...
 [here](https://github.com/jeedom/plugin-template)
...
Récupération d'un template de commande, here le template de commande : plugins/weather/core/template/\$\_version/forecast. (\$\_version valant mobile ou dashboard)
