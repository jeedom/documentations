...
To see [here](https://doc.jeedom.com/en_US/dev/structure_info_json)
...
- To raise the battery (in %) of a piece of equipment, do it on it (Jeedom will take care of the rest and warn the user if necessary) :
