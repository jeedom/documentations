...
We will see later the use of `hasDependency` and `maxDependencyInstallTime`.
...
We start by defining the default location of the progress file in case we did not carry out the previous step correctly...
