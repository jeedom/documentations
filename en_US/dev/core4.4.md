...
The lib *toastr* has been removed from the Core. It was used through the Jeedom Utils functions.showAlert() and hideAlert() have been replaced by the core's internal function jeeDialog.toast().
...
> **Noticed**
>
> These changes may necessitate upgrading many plugins to the minimum required Jeedom version. That's why the *deprecated* They do not appear on a Core in the master branch, but allow developers to see what they can fix.
