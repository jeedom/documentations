...
- You can do PRs (*Pull requests*) on the *repository* Core.
...
The internal functions of the Core are thus well separated, for internal operation (Back-end), but are accessible via the interface. Likewise, each page has its own php and js code. This allows to better develop and maintain the code, but also to optimize performance by loading only the necessary classes and functions.
...
Beyond the pure development of the Core, you can also participate in the Jeedom documentation.
