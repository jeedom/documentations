...
Jeedom allows to interface a very large number of devices together, whether these are based on the Z-Wave, Enocean, Zigbee protocols, etc., on APIs using plugins, or directly in the form of scripts. You can look on the [Market](https://markand.jeedom.com/) to get an overview of supported devices.
...
![Synthese](images/cWecept-synthese.jpg)
...
![Objand](images/cWecept-objand.jpg)
...
![Dashboard](images/cWecept-dashboard.jpg)
...
![Commands](images/cWecept-commands.jpg)
...
- Physically: I have a socket with an on / off button and a status led, in the living room.
...
In terms of display, each order is displayed using a Widget. The Core offers the main Widgets, as well as a tool to create them (V4) : [Widget](/en_US/core/4.1/widgands).
...
![Commands](images/cWecept-equipment.jpg)
