...
The  PowerNode power strip is a smart device that
...
different electrical appliances with a total power of .
...
-    : This is the command that turns on socket 1

-    : It is the command which switches off socket 1

-   Power-1 : This is the command that brings up the instantaneous power
    taken from intake 1

-    : It is the command which reports the total consumption of the
    take 1

-   State-2 : It is the command which allows to know the status of the
    taken 2

-    : It is the command which turns on socket 2

-    : It is the command which switches off socket 2
...
-    : This is the command that turns on socket 3

-    : It is the command which switches off socket 3
...
-    : It is the command which turns on socket 4

-    : It is the command which switches off socket 4
...
-    : It is the command which turns on socket 5

-    : It is the command which switches off socket 5
...
-    : It is the command which turns on socket 6

-    : It is the command which switches off socket 6
