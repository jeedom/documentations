...
. You will therefore be able to operate the connected motor using the existing switch, a Z-Wave transmitter, or directly from the button on the micro-module.
...
-   44: allows you to choose whether or not the consumption and power should include that of the module itself
