...
You must rst connect to telnet (port 23) on openkarotz,
the identier being kartoz

Adding a voice engine 
=========================

Go to / www / cgi-bin / and edit the tts le.inc, add a
    ...
    jeedomTTS function {
       ...
       if ["$ 5" != "1 "]; then
        ...
        if ["$ NOCACHE" == "1"]; then
            ...
            Log "[TTS]" "Storing sound $ {MD5FILE}."
         
       echo $ {MD5FILE}
    }

Then edit the tts le and add :
