...
Il faut aller sur le panneau de Setup puis "Services de
...
(j'ai pas trouvé l'info sur le client web) et aller dans Setup →
stockage :
...
ensuite retourner avec le client lourd dans Setup → stockage :
...
Ensuite sur le NAS dans le panneau de Setup puis portail
...
> Add. Ensuite n'oubliez pas de cliquer sur configurer pour
