...
Wenn alles normal verläuft, wird das Ende des Vorgangs durch folgende Meldung angezeigt: ``[END BACKUP SUCCESS]``
...
Sobald der Migrationsvorgang abgeschlossen ist, erscheint oben auf dem Bildschirm ein grüner Balken mit der Meldung ***Der Vorgang war erfolgreich. Bitte <kbd>F5</kbd> Um die neuesten Informationen zu erhalten***:

![Migration abgeschlossen](../images/migrate-version10.png)

Jetzt müssen Sie nur noch die Taste drücken <kbd>F5</kbd> *(oder die Seite aktualisieren)* um zu überprüfen, ob der Wechsel zu Version 4 tatsächlich erfolgt ist. Es kann sein, dass einige Plugins nach der Migration erneut aktualisiert werden müssen; zögern Sie nicht, diese sofort zu aktualisieren.
