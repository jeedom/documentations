...
If everything goes as expected, the end of the process is indicated by the message: ``[END BACKUP SUCCESS]``
...
Once the migration is complete, a green banner will appear at the top of the screen with the message ***The operation was successful. Please <kbd>F5</kbd> to get the latest updates***:

![Migration complete](../images/migrate-version10.png)

All you have to do now is press the button <kbd>F5</kbd> *(or refresh the page)* to confirm that the upgrade to V4 was successful. Some plugins may need to be updated again following the migration; please update them immediately.
