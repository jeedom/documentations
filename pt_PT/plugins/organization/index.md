...
Plugin pour créer un calendrierPlugin pour récuperer les informations du site DomoGeekPlugin permettant de recuperer les événements de Google Agenda. Il est capable d’interpréter les titres des événements comme interaction.IMPORTANT : ce plugin nécessite d'avoir un compte dev chez Google (tout le monde peut en avoir c'est gratuit et sans impact). La démarche est expliqué dans la documentation. Plugin permettant à Jeedom de gérer la géolocalisation.Plugin pour gerer different mode de sa maison/son appartement| | | | |
|--- | --- | --- | ---|
...
|<img src="gCalendar/gCalendar_icon.png" width="100" />|Google agenda||[Documentation](gCalendar/index.md) - [Market](https://market.jeedom.com/index.php?v=d&p=market_display&id=3318)|
