...
- **Niveau de Log de la librairie Modbus** : Niveau de verbosité de la librairie pymodbus
  ...
  - Aviso : Affiche les avertissements
...
- **Desvio** : Prise en compte du décalage de numérotation des registres (certains équipements commencent à 0, d'autres à 1)
...
4. Renseigner le **registro de partida** et le **nombre de bits à lire**
...
**Exemplo** : Si vous choisissez registre de départ = 1 et nombre = 4, il sera créé :
- ReadCoil_1
- ReadCoil_2  
- ReadCoil_3
- ReadCoil_4
...
5. Renseigner le **registro de partida**
...
- **Escrever Bit** (FC06 pour modifier un bit spécifique)
...
6. Renseigner le **registro de partida** sur la commande
...
3. Renseigner le **registro de partida**
...
Une commande **"Escrever Bit"** est créée par défaut sur vos équipements.
...
**Exemplo** : Si vous lisez 10 registres consécutifs, 10 nouvelles commandes seront créées (une par registre).
