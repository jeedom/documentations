...
>****
>
> Este plugin requer uma chave USB [](http://bit.ly/2n4VyWc)
...
Aqui você encontra a lista de módulos compatíveis com deconz [](https://phoscon.de/en/conbee/compatible)
...
Para instalação remota, aqui está o [](https://phoscon.de/en/conbee/install)
...
Ao restaurar um backup Jeedom, o equipamento é restaurado, mas não está conectado à chave, pode ser necessário reinstalá-la. Para fazer isso, você precisará do backup mencionado acima.  ``plugins/deconz/data``  ``.tar.gz``  ``.dat``. 
...
Vá para [](https://www.dresden-elektronik.de/rpi/deconz-firmware/?C=M;O=D) e verifique se há um novo firmware, se sim, recupere-o
...
>**Estou com o erro "Erro durante a solicitação : .1:8484 / api / 931559A482 / sensores (POST), dados : erro nulo : 1 => usuário não autorizado"**
>
